...
class Model extends \Core\Database\Abstracts\Model {
    ...
    public function create() {
        ...
        try {
            ...
            throw new Exception(strtr(
                    'Framework database error: Failed to create table: @e', ['@e' => $e->getMessage()]
            ));
        }
    }
    ...
    public function insert($row) {
        ...
        try {
            ...
            throw new Exception(strtr(
                    'Framework database error: Failed to insert to table: @e', ['@e' => $e->getMessage()]
            ));
        }
    }
    ...
    public function exists($conditions) {
        ...
        try {
            ...
            throw new Exception(strtr(
                    'Framework database error: Failed to check record existance from table: @e', ['@e' => $e->getMessage()]
            ));
        }
    }
    ...
    public function update($row = [], $conditions = []) {
        ...
        try {
            ...
            throw new Exception(strtr(
                    'Framework database error: Failed to update table: @e', ['@e' => $e->getMessage()]
            ));
        }
    }
    ...
    public function delete($conditions = []) {
        ...
        try {
            ...
            throw new Exception(strtr(
                    'Framework database error: Failed to delete from table: @e', ['@e' => $e->getMessage()]
            ));
        }
    }
